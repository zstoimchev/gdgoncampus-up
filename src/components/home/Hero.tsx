    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
            ...
            <div className="absolute inset-0 z-0">
                <div className="absolute inset-0 bg-linear-to-br from-google-blue/10 via-google-red/10 to-google-yellow/10 animate-gradient" />
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,var(--tw-gradient-stops))] from-google-blue/20 via-dark-900 to-dark-900" />
            </div>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        <div className="inline-flex items-center px-4 py-2 rounded-full bg-google-blue/10 border border-google-blue/20 mb-6">
